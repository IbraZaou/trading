    ...
    <main class="main-silver">
        ...
        <div class="icon-silver">
            ...
            <div class="silver">
                        ...
                        <div id="paypal-button-container-P-83Y70943C7470123YMN4JUWQ"></div>
                            <script src="https://www.paypal.com/sdk/js?client-id=AZCYK5R6Dj7v4YKke3_vm9gTMk5nnRZNCOTNmw35RfqxRzaaTlECWw5qdeY-0UhuEhrV6Af4HkkB-w4h&vault=true&intent=subscription" data-sdk-integration-source="button-factory"></script>
                            <script>
                            paypal.Buttons({
                                style: {
                                    shape: 'pill',
                                ...
                                createSubscription: function(data, actions) {
                                    ...
                                    plan_id: 'P-83Y70943C7470123YMN4JUWQ'
                                    });
                                },
                                onApprove: function(data, actions) {
                                    alert(data.subscriptionID); // You can add optional success message for the subscriber here
                                }
                            }).render('#paypal-button-container-P-83Y70943C7470123YMN4JUWQ'); // Renders the PayPal button
                            </script>
